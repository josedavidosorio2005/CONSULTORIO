...
export default function ContactoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast({
        ...
        message: 'Hubo un problema al procesar tu mensaje. Inténtalo de nuevo.'
      });
    } finally {
  ...
  const getFieldClasses = (fieldName: keyof ContactFormData) => {
    ...
    return `${baseClasses} ${isFieldInvalid(fieldName as keyof ContactFormData) ? errorClasses : normalClasses}`;
  };
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-2.5">
                <textarea
                  ...
                  className={getFieldClasses('mensaje')}
