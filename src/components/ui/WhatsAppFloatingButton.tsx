...
export default function WhatsAppFloatingButton({ phoneNumber, message = 'Hola, me gustaría agendar una cita.' }: WhatsAppButtonProps) {
        ...
        <AnimatePresence>
          {isHovered && (
            <motion.span
              ...
              exit={{ opacity: 0, x: 10 }}
              className="absolute right-full mr-4 whitespace-nowrap bg-white dark:bg-gray-800 px-4 py-2 rounded-lg shadow-lg text-sm font-medium"
            >
              ¡Chatea con nosotros!
            </motion.span>
          )}
